...
-- Clear any existing seed records to ensure clean insert
...
-- UPDATE EMPLOYEES WITH ASSIGNED ROLE AND DEPARTMENT
update public.employees set role = 'Admin', department_id = '00000000-0000-0000-0000-000000000001' where email = 'admin@gmail.com';
update public.employees set role = 'DeptHead', department_id = '00000000-0000-0000-0000-000000000001' where email = 'ithead@company.com';
update public.employees set role = 'AssetManager', department_id = '00000000-0000-0000-0000-000000000001' where email = 'itmanager@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000001' where email = 'itemp1@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000001' where email = 'itemp2@company.com';
update public.employees set role = 'DeptHead', department_id = '00000000-0000-0000-0000-000000000002' where email = 'hrhead@company.com';
update public.employees set role = 'AssetManager', department_id = '00000000-0000-0000-0000-000000000002' where email = 'hrmanager@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000002' where email = 'hremp1@company.com';
update public.employees set role = 'DeptHead', department_id = '00000000-0000-0000-0000-000000000003' where email = 'opshead@company.com';
update public.employees set role = 'AssetManager', department_id = '00000000-0000-0000-0000-000000000003' where email = 'opsmanager@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000003' where email = 'opsemp1@company.com';
update public.employees set role = 'DeptHead', department_id = '00000000-0000-0000-0000-000000000004' where email = 'mkthead@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000004' where email = 'mktemp1@company.com';
update public.employees set role = 'DeptHead', department_id = '00000000-0000-0000-0000-000000000005' where email = 'finhead@company.com';
update public.employees set role = 'Employee', department_id = '00000000-0000-0000-0000-000000000005' where email = 'finemp1@company.com';
